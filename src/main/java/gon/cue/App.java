 ...
 */
public class App implements MegaRequestListenerInterface, MegaTransferListenerInterface, MegaGlobalListenerInterface {
    ...
    public App() {
        ...
        if (megaApi == null) {
            ...
            megaApi = new MegaApiJava(App.APP_KEY, path);
        }
    }
    ...
    public void onRequestFinish(MegaApiJava api, MegaRequest request, MegaError e) {
        log.fine("Request finish (" + request.getRequestString() + "); Result: " + e.toString());
        ...
        if (requestType == MegaRequest.TYPE_LOGIN) {
            ...
            log.info("Storage: " + accountDetails.getStorageUsed() + " of " + accountDetails.getStorageMax() + " ("
                     + String.valueOf((int)(100.0 * accountDetails.getStorageUsed() / accountDetails.getStorageMax())) + " %)");
    ...
    public void onRequestTemporaryError(MegaApiJava api, MegaRequest request, MegaError e) {
        log.warning("Request temporary error (" + request.getRequestString() + "); Error: " + e.toString());
    }
    ...
    public void onTransferFinish(MegaApiJava api, MegaTransfer transfer, MegaError e) {
        log.fine("Transfer finished (" + transfer.getFileName() + "); Result: " + e.toString() + " ");
    ...
    public void onTransferUpdate(MegaApiJava api, MegaTransfer transfer) {
        log.fine("Transfer finished (" + transfer.getFileName() + "): " + transfer.getSpeed() + " B/s ");
    }
    ...
    public void onTransferTemporaryError(MegaApiJava api, MegaTransfer transfer, MegaError e) {
        log.warning("Transfer temporary error (" + transfer.getFileName() + "); Error: " + e.toString());
    }
