...
import gon.cue.core.props.PropertiesReader;
import gon.cue.core.ui.BaseGraphics;
import gon.cue.core.ui.IconCache;
import gon.cue.core.ui.swtresources.SWTResourceManager;
...
public class Window extends BaseGraphics {
    ...
    private final String[]          tableTitles                 = new String[]{PropertiesReader.getResourceString("table.Name.title"),
            PropertiesReader.getResourceString("table.Size.title"), PropertiesReader.getResourceString("table.Type.title"),
            PropertiesReader.getResourceString("table.Modified.title")};
    private Table                   table;
    ...
    public Window() {
        super();
        shell.setText(PropertiesReader.getResourceString("Title", new Object[]{""}));
        shell.setImage(SWTResourceManager.getImage(getClass(), "/gon/cue/core/ui/icons/generic_example.gif"));
    ...
    private void createFileMenu(Menu parent) {
        ...
        header.setText(PropertiesReader.getResourceString("menu.File.text"));
        header.setMenu(menu);

        final MenuItem simulateItem = new MenuItem(menu, SWT.CHECK);
        simulateItem.setText(PropertiesReader.getResourceString("menu.File.SimulateOnly.text"));
        ...
        item.setText(PropertiesReader.getResourceString("menu.File.Close.text"));
    ...
    private void createHelpMenu(Menu parent) {
        Menu menu = new Menu(parent);
        MenuItem header = new MenuItem(parent, SWT.CASCADE);
        header.setText(PropertiesReader.getResourceString("menu.Help.text"));
        header.setMenu(menu);

        MenuItem item = new MenuItem(menu, SWT.PUSH);
        item.setText(PropertiesReader.getResourceString("menu.Help.About.text"));
        item.addSelectionListener(widgetSelectedAdapter(e -> {
            MessageBox box = new MessageBox(shell, SWT.ICON_INFORMATION | SWT.OK);
            box.setText(PropertiesReader.getResourceString("dialog.About.title"));
            box.setMessage(PropertiesReader.getResourceString("dialog.About.description", new Object[]{System.getProperty("os.name")}));
            box.open();
        }));
    }
    ...
    private void createToolBar(final Shell shell, Object layoutData) {
        ...
        item.setImage(SWTResourceManager.getImage(Window.class, "/org/citi/fileview/icons/cmd_Parent.gif"));
        item.setToolTipText(PropertiesReader.getResourceString("tool.Parent.tiptext"));
        item.addSelectionListener(widgetSelectedAdapter(e -> doParent()));
        item = new ToolItem(toolBar, SWT.PUSH);
        item.setImage(SWTResourceManager.getImage(Window.class, "/org/citi/fileview/icons/cmd_Refresh.gif"));
        item.setToolTipText(PropertiesReader.getResourceString("tool.Refresh.tiptext"));
        ...
        SelectionListener unimplementedListener = widgetSelectedAdapter(e -> {
            MessageBox box = new MessageBox(shell, SWT.ICON_INFORMATION | SWT.OK);
            box.setText(PropertiesReader.getResourceString("dialog.NotImplemented.title"));
            box.setMessage(PropertiesReader.getResourceString("dialog.ActionNotImplemented.description"));
            box.open();
        });

        item = new ToolItem(toolBar, SWT.SEPARATOR);
        item = new ToolItem(toolBar, SWT.PUSH);
        item.setImage(SWTResourceManager.getImage(Window.class, "/org/citi/fileview/icons/cmd_Cut.gif"));
        item.setToolTipText(PropertiesReader.getResourceString("tool.Cut.tiptext"));
        item.addSelectionListener(unimplementedListener);
        item = new ToolItem(toolBar, SWT.PUSH);
        item.setImage(SWTResourceManager.getImage(Window.class, "/org/citi/fileview/icons/cmd_Copy.gif"));
        item.setToolTipText(PropertiesReader.getResourceString("tool.Copy.tiptext"));
        item.addSelectionListener(unimplementedListener);
        item = new ToolItem(toolBar, SWT.PUSH);
        item.setImage(SWTResourceManager.getImage(Window.class, "/org/citi/fileview/icons/cmd_Paste.gif"));
        item.setToolTipText(PropertiesReader.getResourceString("tool.Paste.tiptext"));
        item.addSelectionListener(unimplementedListener);

        item = new ToolItem(toolBar, SWT.SEPARATOR);
        item = new ToolItem(toolBar, SWT.PUSH);
        item.setImage(SWTResourceManager.getImage(Window.class, "/org/citi/fileview/icons/cmd_Delete.gif"));
        item.setToolTipText(PropertiesReader.getResourceString("tool.Delete.tiptext"));
        item.addSelectionListener(unimplementedListener);
        item = new ToolItem(toolBar, SWT.PUSH);
        item.setImage(SWTResourceManager.getImage(Window.class, "/org/citi/fileview/icons/cmd_Rename.gif"));
        item.setToolTipText(PropertiesReader.getResourceString("tool.Rename.tiptext"));
        item.addSelectionListener(unimplementedListener);

        item = new ToolItem(toolBar, SWT.SEPARATOR);
        item = new ToolItem(toolBar, SWT.PUSH);
        item.setImage(SWTResourceManager.getImage(Window.class, "/org/citi/fileview/icons/cmd_Search.gif"));
        item.setToolTipText(PropertiesReader.getResourceString("tool.Search.tiptext"));
        item.addSelectionListener(unimplementedListener);
        item = new ToolItem(toolBar, SWT.PUSH);
        item.setImage(SWTResourceManager.getImage(Window.class, "/org/citi/fileview/icons/cmd_Print.gif"));
        item.setToolTipText(PropertiesReader.getResourceString("tool.Print.tiptext"));
        item.addSelectionListener(unimplementedListener);
    }
    ...
    private void createTreeView(Composite parent) {
        ...
        treeScopeLabel.setText(PropertiesReader.getResourceString("details.AllFolders.text"));
    ...
    private void treeRefreshItem(TreeItem dirItem, boolean forcePopulate) {
        ...
        File[] subFiles = (dir != null) ? Window.getDirectoryList(dir) : null;
    ...
    void notifySelectedDirectory(File dir) {
         ...
         */
        shell.setText(PropertiesReader.getResourceString("Title", new Object[]{currentDirectory.getPath()}));
    ...
    void notifySelectedFiles(File[] files) {
        ...
        if ((files != null) && (files.length != 0)) {
            numObjectsLabel.setText(PropertiesReader.getResourceString("details.NumberOfSelectedFiles.text", new Object[]{Integer.valueOf(files.length)}));
            long fileSize = 0L;
            for (File file : files) {
                fileSize += file.length();
            }
            diskSpaceLabel.setText(PropertiesReader.getResourceString("details.FileSize.text", new Object[]{Long.valueOf(fileSize)}));
        } else {
            // No files selected
            diskSpaceLabel.setText("");
            if (currentDirectory != null) {
                int numObjects = getDirectoryList(currentDirectory).length;
                numObjectsLabel.setText(PropertiesReader.getResourceString("details.DirNumberOfObjects.text", new Object[]{Integer.valueOf(numObjects)}));
            } else {
    ...
    void doDefaultFileAction(File[] files) {
        ...
        if (file.isDirectory()) {
            ...
            if (!Program.launch(fileName)) {
                ...
                dialog.setMessage(PropertiesReader.getResourceString("error.FailedLaunch.message", new Object[]{fileName}));
            ...
            while (!progressDialog.isCancelled()) {
                if (copyFileStructure(source, dest)) {
                    ...
                    if (event.detail == DND.DROP_MOVE && (!isDragging)) {
                        ...
                        box.setText(PropertiesReader.getResourceString("dialog.FailedCopy.title"));
                        box.setMessage(PropertiesReader.getResourceString("dialog.FailedCopy.description", new Object[]{source, dest}));
                        int button = box.open();
        ...
        for (int i = 0; (i < sourceFiles.length) && (!progressDialog.isCancelled()); i++) {
            ...
            while (!progressDialog.isCancelled()) {
                if (deleteFileStructure(source)) {
                    ...
                    MessageBox box = new MessageBox(shell, SWT.ICON_ERROR | SWT.ABORT | SWT.RETRY | SWT.IGNORE);
                    box.setText(PropertiesReader.getResourceString("dialog.FailedDelete.title"));
                    box.setMessage(PropertiesReader.getResourceString("dialog.FailedDelete.description", new Object[]{source}));
                    int button = box.open();
                    if (button == SWT.ABORT)
                        i = sourceNames.length;
                    if (button == SWT.RETRY)
    ...
    boolean copyFileStructure(File oldFile, File newFile) {
        ...
        if (oldFile.isDirectory()) {
            ...
            if (simulateOnly) {
                // System.out.println(PropertiesReader.getResourceString("simulate.DirectoriesCreated.text",
             ...
             */
            if (simulateOnly) {
                // System.out.println(PropertiesReader.getResourceString("simulate.CopyFromTo.text",
    ...
    boolean deleteFileStructure(File oldFile) {
        ...
        if (simulateOnly) {
            // System.out.println(PropertiesReader.getResourceString("simulate.Delete.text",
    ...
    private void workerExecute() {
        ...
        display.syncExec(() -> {
            tableContentsOfLabel.setText(PropertiesReader.getResourceString("details.ContentsOf.text", new Object[]{workerStateDir.getPath()}));
            table.removeAll();
    ...
    private void workerAddFileDetails(final File file) {
        ...
        if (file.isDirectory()) {
            typeString = PropertiesReader.getResourceString("filetype.Folder");
            sizeString = "";
            iconImage = iconCache.stockImages[iconCache.iconClosedFolder];
        } else {
            sizeString = PropertiesReader.getResourceString("filesize.KB", new Object[]{Long.valueOf((file.length() + 512) / 1024)});
            ...
            if (dot != -1) {
                ...
                if (program != null) {
                    ...
                    typeString = PropertiesReader.getResourceString("filetype.Unknown", new Object[]{extension.toUpperCase()});
                    iconImage = iconCache.stockImages[iconCache.iconFile];
                }
            } else {
                typeString = PropertiesReader.getResourceString("filetype.None");
                iconImage = iconCache.stockImages[iconCache.iconFile];
            }
        }
