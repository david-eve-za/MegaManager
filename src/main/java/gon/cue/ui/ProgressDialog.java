...
public class ProgressDialog {
    ...
    /**
		...
		public ProgressDialog(Shell parent, int style) {
			...
			shell.setText(PropertiesReader.getResourceString("progressDialog." + operationKeyName[style] + ".title"));
			...
			messageLabel.setText(PropertiesReader.getResourceString("progressDialog." + operationKeyName[style] + ".description"));
			...
			cancelButton.setText(PropertiesReader.getResourceString("progressDialog.cancelButton.text"));
		...
		public void setDetailFile(File file, int operation) {
			detailLabel.setText(PropertiesReader.getResourceString("progressDialog." + operationKeyName[operation] + ".operation",
					new Object[] { file }));
		}
